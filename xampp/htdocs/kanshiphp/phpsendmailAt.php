...
if (strtoupper(substr(PHP_OS,0,3))==='WIN') {
  ...
  if(count($rtnv)==2){
    ...
    $msg="vpath_phpmailer and/or vpath_htdocs invalid, check kanshiphp.ini";
    writeloge($pgm,$msg);
    return 1;
  }
}
...
////
    if ($mailRows[0]=='127.0.0.1' or $hst=='127.0.0.1'){
      $msg="Mail Server 127.0.0.1 not use"; // 127.0.0.1は使えない
      writeloge($pgm,$msg);
      return 1;
    }else{
      if (empty($hst) || $hst==""){
...
/*
// test
$from='vmadmin@mydomain.jp';
$to='mailuser@mydomain.jp';
$arrayat=array('192.168.1.155.cpu-day.png','192.168.1.155.svg','192.168.1.155.ram-day.png');
$rtncd=phpsendmailat('192.168.1.139',25, $from, $to, '画像添付混合', 'png,svg添付参照',$arrayat);
var_dump($rtncd);
*/
?>
