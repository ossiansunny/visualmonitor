...
//print '&emsp;&emsp;&emsp;&emsp;<td><span class=trylw><a href="" onclick="viewPopup(\''.$popupRtnData.'\'); return false;">Webログ：</a></span><span class=trblk><input type="radio" name="log" value="Web" '.$webdisabled.'></span></td>';
