...
///
  ...
  ///
if ( isset($_GET['plan']) or isset($_GET['prog']) or isset($_GET['idea']) or isset($_GET['tips']) or 
     isset($_GET['save']) or isset($_GET['all']) or isset($_GET['search']) or isset($_GET['param']) ) {
  $user=$_GET['user'];
  if (isset($_GET['all'])){
